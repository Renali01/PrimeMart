    ...
    <div classname='home'>
        <div className="home__container">
            ...
            <div className="home__row">
                <Product title = 'Scale Your Everest: How to be a Resilient Entrepreneur'
                price={9.99} image="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcRqmdu-vqt69ldk-DTEyQVZr1Bsy69GC1SYtipkIqommJHtlC0G"
                rating={4}
                />
                <Product title = 'How to Win Friends and Influence People'
            ...
            <div className="home__row">
                ...
                rating={3}/>
                <Product title ='The Unabridged Journals of Sylvia Plath'
